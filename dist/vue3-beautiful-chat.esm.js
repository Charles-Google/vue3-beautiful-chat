import { reactive, openBlock, createElementBlock, normalizeStyle, createCommentVNode, renderSlot, createTextVNode, toDisplayString, createElementVNode, resolveComponent, createVNode, withCtx, pushScopeId, popScopeId, resolveDirective, normalizeClass, withDirectives, createBlock, Fragment, renderList, vShow, withModifiers, nextTick, withScopeId, withKeys, mergeProps, ref, createApp, h } from "vue";
const store = {
  state: reactive({
    editMessage: null
  }),
...
function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_solt = resolveComponent("solt");
    ...
    createElementVNode("form", {
      ...
      createElementVNode("div", _hoisted_5$1, [
        ...
        $props.showEmoji && !$options.isEditing ? (openBlock(), createElementBlock("div", _hoisted_7$1, [
          createVNode(_component_solt, { name: "need" })
        ])) : createCommentVNode("", true),
